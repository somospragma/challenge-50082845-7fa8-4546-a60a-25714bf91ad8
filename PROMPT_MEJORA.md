...
// === ARCHIVO: queries/precio_promedio_por_categoria.sql ===
SELECT categoria, AVG(precio) AS precio_promedio FROM productos GROUP BY categoria;

// === ARCHIVO: transactions/actualizar_stock_despues_venta.sql ===
BEGIN TRANSACTION;
UPDATE productos SET stock = stock - 1 WHERE id =?;
COMMIT;

// === ARCHIVO: transactions/insertar_producto_y_actualizar_stock.sql ===
BEGIN TRANSACTION;
